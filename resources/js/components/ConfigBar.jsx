...
export default function ConfigBar({ config, setConfig, soundEnabled, setSoundEnabled, onSettingsClick }) {
    return (
        <motion.div
        ...
        >
            ...
            <button
                ...
                className="flex items-center gap-2 text-sub hover:text-main transition-colors px-2"
                title="Open Settings"
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
